  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-bg px-4 py-16 sm:px-6 lg:px-8">
      <div className="w-full max-w-md overflow-hidden rounded-[2rem] border border-line bg-surface shadow-[0_20px_45px_-25px_rgba(36,20,23,0.35)]">
        <div className="bg-brand-deep px-8 py-5">
          <p className="font-display text-xs font-medium tracking-[0.3em] text-sun uppercase">Inscripción confirmada</p>
        </div>
        ...
        <div className="px-8 py-8">
          ...
          <Link
            href="/"
            className="mt-8 inline-flex rounded-full bg-brand px-6 py-3 font-display font-medium text-cream transition hover:bg-brand-deep"
          >
            Volver al inicio
          </Link>
        </div>
